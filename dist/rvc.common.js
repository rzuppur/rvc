...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"tabs"},[_c('div',{staticClass:"tabs-tabs space-bottom-large"},_vm._l((_vm.tabs),function(tab){return _c('r-button',{key:'tab-' + tab.name,staticClass:"tab",class:{ active: tab.isActive },attrs:{"action":function () { _vm.setTabActive(tab.name); },"borderless":"borderless"}},[_c('span',{class:{ 'text-quiet': !tab.isActive }},[_vm._v(_vm._s(tab.name))])])}),1),_c('div',{staticClass:"tabs-content"},[_vm._t("default")],2)])};
var __vue_staticRenderFns__ = [];

  /* style */
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-b7fd70e0_0", { source: ".tab[data-v-b7fd70e0]{border-radius:0}.tab.active[data-v-b7fd70e0]{border-top:3px solid transparent;border-bottom:3px solid #0d7cc8}.tab .text-quiet[data-v-b7fd70e0]{font-weight:400}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$2 = "data-v-b7fd70e0";
  /* module identifier */
...
var __vue_staticRenderFns__$1 = [];
  ...
  /* scoped */
  const __vue_scope_id__$3 = "data-v-46abd47f";
  /* module identifier */
...
/* template */
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-ab7cbc94_0", { source: "*,::after,::before{box-sizing:border-box}ol[class],ul[class]{padding:0;list-style:none}blockquote,body,dd,dl,figcaption,figure,h1,h2,h3,h4,li,ol[class],p,pre,ul[class]{margin:0}body{min-height:100vh;scroll-behavior:smooth;-webkit-text-size-adjust:100%;text-size-adjust:100%;font-kerning:normal;background:#fff}a:not([class]){text-decoration-skip-ink:auto}img{max-width:100%;display:block}button,input,select,textarea{font:inherit}h1,h2,h3,h4,h5,h6{font-weight:inherit;font-size:inherit}body{font-family:Inter,BlinkMacSystemFont,-apple-system,\"Segoe UI\",Roboto,Oxygen-Sans,Ubuntu,Cantarell,\"Helvetica Neue\",sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";line-height:1.5}b,strong{font-weight:600}p,pre{margin-bottom:16px}p:last-child,pre:last-child{margin-bottom:0}p{word-wrap:break-word;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:400}.title-1{word-wrap:break-word;margin-bottom:16px}.title-2{word-wrap:break-word;margin-bottom:16px}.title-3{word-wrap:break-word;margin-bottom:16px}.title-4{word-wrap:break-word;margin-bottom:16px}.title-5{word-wrap:break-word;margin-bottom:16px}.title-6{word-wrap:break-word;margin-bottom:16px}.title-1{font-size:48px;letter-spacing:-.017em;line-height:57px;font-weight:400}.title-2{font-size:39px;letter-spacing:-.017em;line-height:50px;font-weight:400}.title-3{font-size:31px;letter-spacing:-.016em;line-height:42px;font-weight:400}.title-4{font-size:25px;letter-spacing:-.014em;line-height:35px;font-weight:400}.title-5{font-size:20px;letter-spacing:-.011em;line-height:29px;font-weight:400}.title-6{font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600}.title-caps{word-wrap:break-word;margin-bottom:16px;font-size:13px;letter-spacing:.004em;line-height:20px;font-weight:600;text-transform:uppercase;letter-spacing:.08em}.text-bold{font-weight:600}.text-center{text-align:center}.text-right{text-align:right}.text-quiet{color:#777}.darkMode .text-quiet{color:#aab0b6}.text-error{color:#a61216}.darkMode .text-error{color:#e24161}.text-small{font-size:13px;letter-spacing:.004em;line-height:20px;font-weight:400}hr{height:2px;border:none;outline:0;margin:16px 0;padding:0;box-shadow:none;background:#f9f9fa}.darkMode hr{background:rgba(255,255,255,.1)}.space-top-tiny{margin-top:4px}.space-top-small{margin-top:8px}.space-top-medium{margin-top:16px}.space-top-large{margin-top:32px}.space-bottom-tiny{margin-bottom:4px}.space-bottom-small{margin-bottom:8px}.space-bottom-medium{margin-bottom:16px}.space-bottom-large{margin-bottom:32px}.margin-vertical-none{margin-top:0!important;margin-bottom:0!important}.margin-none{margin:0!important}", map: undefined, media: undefined });
...
var __vue_staticRenderFns__$2 = [];
  ...
  const __vue_inject_styles__$5 = function (inject) {
    if (!inject) return
    inject("data-v-c5e58d58_0", { source: ".toast-list[data-v-c5e58d58]{position:fixed;top:36px;left:10px;right:10px;z-index:1100;user-select:none;pointer-events:none}.toast-list-inner[data-v-c5e58d58]{max-width:700px;margin:0 auto;position:relative;text-align:center}.toast-notification[data-v-c5e58d58]{display:inline-block;padding:15px 25px;margin-bottom:5px;word-break:break-word;color:#fff;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600;background:#40444a;border-radius:4px;box-shadow:0 2px 10px -2px rgba(0,0,0,.2);pointer-events:all;user-select:none}.toast-list-enter[data-v-c5e58d58],.toast-list-leave-to[data-v-c5e58d58]{opacity:0}.toast-list-enter-active[data-v-c5e58d58],.toast-list-leave-active[data-v-c5e58d58],.toast-list-move[data-v-c5e58d58]{transition:all .2s}.toast-list-leave-active[data-v-c5e58d58]{position:absolute;left:0;right:0}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$5 = "data-v-c5e58d58";
  /* module identifier */
...
var __vue_staticRenderFns__$3 = [];
  ...
  const __vue_inject_styles__$6 = function (inject) {
    if (!inject) return
    inject("data-v-ad4b6926_0", { source: ".tooltip-enter-active[data-v-ad4b6926]{transition:opacity .1s}.tooltip-enter[data-v-ad4b6926]{opacity:0}.tooltip-arrow-enter-active[data-v-ad4b6926]{transition:opacity 150ms}.tooltip-arrow-enter[data-v-ad4b6926]{opacity:0}.r-tooltip[data-v-ad4b6926]{position:fixed;z-index:1000;padding:5px 12px;margin-right:5px;word-break:break-word;color:#fff;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600;background:#40444a;border-radius:4px;box-shadow:0 2px 10px -2px rgba(0,0,0,.2);pointer-events:none;user-select:none}.r-tooltip-arrow[data-v-ad4b6926]{position:fixed;z-index:1001;border-top:7px solid #40444a;border-left:7px solid transparent;border-right:7px solid transparent;border-bottom:7px solid transparent;pointer-events:none;user-select:none}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$6 = "data-v-ad4b6926";
  /* module identifier */
