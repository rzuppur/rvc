...
(function (global, factory) {
  ...
  var __vue_staticRenderFns__ = [];
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-27bc0ec2_0", { source: ".modal-enter-active[data-v-27bc0ec2],.modal-leave-active[data-v-27bc0ec2]{transition:opacity 120ms ease-out}.modal-enter-active .modal[data-v-27bc0ec2],.modal-leave-active .modal[data-v-27bc0ec2]{transition:transform 120ms ease-out}.modal-enter[data-v-27bc0ec2],.modal-leave-to[data-v-27bc0ec2]{opacity:0}.modal-enter .modal[data-v-27bc0ec2],.modal-leave-to .modal[data-v-27bc0ec2]{transform:scale(.97)}@media (max-width:480px){.modal-enter-active[data-v-27bc0ec2],.modal-leave-active[data-v-27bc0ec2]{transition:opacity 170ms ease-out}.modal-enter-active .modal[data-v-27bc0ec2],.modal-leave-active .modal[data-v-27bc0ec2]{transition:transform 240ms cubic-bezier(.31,.79,.46,.92)}.modal-enter .modal[data-v-27bc0ec2],.modal-leave-to .modal[data-v-27bc0ec2]{transform:translateY(12px)}}.modal-overlay[data-v-27bc0ec2]{overflow:hidden;-webkit-overflow-scrolling:touch;background:rgba(0,0,0,.6);position:fixed;text-align:center;left:0;top:0;right:0;bottom:0;height:100%}@supports (display:grid){@media (min-width:481px){.modal-overlay[data-v-27bc0ec2]{grid-template-columns:100%;grid-template-rows:1fr max-content 2fr;display:grid}.modal-overlay .modal-container[data-v-27bc0ec2]{grid-column:1;grid-row:2;width:100%}}}.modal-overlay.white[data-v-27bc0ec2]{background:rgba(255,255,255,.93)}.modal-container[data-v-27bc0ec2]{text-align:left}.modal[data-v-27bc0ec2]{background:#fff;border-radius:4px;box-shadow:0 0 0 3px rgba(0,0,0,.1),0 15px 10px -5px rgba(0,0,0,.07);word-wrap:break-word;overflow-y:auto;display:flex;flex-direction:column;max-height:calc(100vh - 24px)}.modal-buttons[data-v-27bc0ec2],.modal-header[data-v-27bc0ec2]{padding:24px;flex:0 0 auto}.modal-header[data-v-27bc0ec2]{padding-bottom:12px}.modal-header[data-v-27bc0ec2]{display:flex}.modal-header .title[data-v-27bc0ec2]{flex:1 1 auto;align-self:center;margin:0}.modal-header .modal-close[data-v-27bc0ec2]{flex:0 0 auto;align-self:flex-start}.modal-content[data-v-27bc0ec2]{padding:0 24px;flex:0 1 auto;overflow:hidden}.modal-content.modal-content-scroll[data-v-27bc0ec2]{min-height:48px;padding:0 24px 24px;overflow-y:auto}.modal-content.modal-content-scroll.show-top-border[data-v-27bc0ec2]{box-shadow:inset 0 12px 12px -12px rgba(0,0,0,.1)}.modal-content.modal-content-scroll.show-bottom-border[data-v-27bc0ec2]{box-shadow:inset 0 -12px 12px -12px rgba(0,0,0,.1)}.modal-content.modal-content-scroll.show-top-border.show-bottom-border[data-v-27bc0ec2]{box-shadow:inset 0 12px 12px -12px rgba(0,0,0,.1),inset 0 -12px 12px -12px rgba(0,0,0,.1)}@media (max-width:480px){.modal-container[data-v-27bc0ec2]{padding:0}.modal-container[data-v-27bc0ec2]{justify-content:flex-end;height:100%;display:flex;flex-direction:column}.modal[data-v-27bc0ec2]{border-radius:0}}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$2 = "data-v-27bc0ec2";
    /* module identifier */
