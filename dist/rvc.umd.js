...
(function (global, factory) {
  ...
  /* template */
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-e8be3144_0", { source: ".r-icon{height:24px;width:24px;display:inline-block}.r-icon.icon-text{vertical-align:text-top;display:inline-block;position:relative;top:1px}.r-icon.icon-text,.r-icon.icon-text svg{height:18px!important;width:18px!important}.darkMode .r-icon svg{fill:#e1e3e5}.r-icon.gray svg{fill:#777}.darkMode .r-icon.gray svg{fill:#aab0b6}.r-icon.light-gray svg{fill:$color-gray-text-light}.r-icon.green svg{fill:#009826}.r-icon.red svg{fill:#e24161}.r-icon.blue svg{fill:#2c61b6}.darkMode .r-icon.blue svg{fill:#0f91ea}.r-icon.white svg{fill:#fff}", map: undefined, media: undefined });
  ...
  var __vue_staticRenderFns__$1 = [];
    ...
    const __vue_inject_styles__$3 = function (inject) {
      if (!inject) return
      inject("data-v-62617c76_0", { source: ".tooltip-enter-active[data-v-62617c76]{transition:opacity .1s}.tooltip-enter[data-v-62617c76]{opacity:0}.tooltip-arrow-enter-active[data-v-62617c76]{transition:opacity 150ms}.tooltip-arrow-enter[data-v-62617c76]{opacity:0}.r-tooltip[data-v-62617c76]{position:fixed;z-index:1000;padding:5px 12px;margin-right:5px;word-break:break-word;color:#fff;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600;background:#40444a;border-radius:4px;box-shadow:0 2px 10px -2px rgba(0,0,0,.2);pointer-events:none;user-select:none}.r-tooltip-arrow[data-v-62617c76]{position:fixed;z-index:1001;border-top:7px solid #40444a;border-left:7px solid transparent;border-right:7px solid transparent;border-bottom:7px solid transparent}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$3 = "data-v-62617c76";
    /* module identifier */
