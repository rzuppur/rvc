...
(function (global, factory) {
  ...
  var __vue_staticRenderFns__ = [];
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-753ceb83_0", { source: ".modal-enter-active[data-v-753ceb83],.modal-leave-active[data-v-753ceb83]{transition:opacity 120ms ease-out}.modal-enter-active .modal[data-v-753ceb83],.modal-leave-active .modal[data-v-753ceb83]{transition:transform 120ms ease-out}.modal-enter[data-v-753ceb83],.modal-leave-to[data-v-753ceb83]{opacity:0}.modal-enter .modal[data-v-753ceb83],.modal-leave-to .modal[data-v-753ceb83]{transform:scale(.97)}@media (max-width:480px){.modal-enter-active[data-v-753ceb83],.modal-leave-active[data-v-753ceb83]{transition:opacity 170ms ease-out}.modal-enter-active .modal[data-v-753ceb83],.modal-leave-active .modal[data-v-753ceb83]{transition:transform .2s cubic-bezier(.31,.79,.46,.92)}.modal-enter .modal[data-v-753ceb83],.modal-leave-to .modal[data-v-753ceb83]{transform:translateY(12px)}}.modal-overlay[data-v-753ceb83]{overflow:hidden;-webkit-overflow-scrolling:touch;position:fixed;text-align:center;left:0;top:0;right:0;bottom:0;height:100%;background:rgba(24,27,34,.6)}.darkMode .modal-overlay[data-v-753ceb83]{background:rgba(19,22,27,.9)}@supports (display:grid){@media (min-width:481px){.modal-overlay[data-v-753ceb83]{grid-template-columns:100%;grid-template-rows:1fr max-content 2fr;display:grid}.modal-overlay .modal-container[data-v-753ceb83]{grid-column:1;grid-row:2;width:100%}}}.modal-container[data-v-753ceb83]{text-align:left}.modal[data-v-753ceb83]{border-radius:4px;word-wrap:break-word;overflow-y:auto;display:flex;flex-direction:column;max-height:calc(100vh - 24px);box-shadow:0 0 0 3px rgba(0,0,0,.15),0 15px 10px -5px rgba(0,0,0,.07)}.darkMode .modal[data-v-753ceb83]{box-shadow:0 0 0 3px rgba(255,255,255,.1),0 15px 30px -5px rgba(0,0,0,.5)}.modal-buttons[data-v-753ceb83],.modal-header[data-v-753ceb83]{padding:24px;flex:0 0 auto}.modal-header[data-v-753ceb83]{padding-bottom:12px}.modal-header[data-v-753ceb83]{display:flex}.modal-header .title[data-v-753ceb83]{flex:1 1 auto;align-self:center;margin:0}.modal-header .modal-close[data-v-753ceb83]{flex:0 0 auto;align-self:flex-start}.modal-content[data-v-753ceb83]{padding:0 24px;flex:0 1 auto;overflow:hidden}.modal-content.no-buttons[data-v-753ceb83]{padding-bottom:24px}.modal-content.modal-content-scroll[data-v-753ceb83]{min-height:48px;padding:0 24px 24px;overflow-y:auto}@media (max-width:480px){.modal-container[data-v-753ceb83]{padding:0}.modal-container[data-v-753ceb83]{justify-content:flex-end;height:100%;display:flex;flex-direction:column}.modal[data-v-753ceb83]{border-radius:0}}.bottom-shadow[data-v-753ceb83],.top-shadow[data-v-753ceb83]{position:relative}.bottom-shadow[data-v-753ceb83]:after,.top-shadow[data-v-753ceb83]:after{content:\"\";user-select:none;pointer-events:none;height:20px;position:absolute;left:0;right:0;opacity:.07}.darkMode .bottom-shadow[data-v-753ceb83],.darkMode .top-shadow[data-v-753ceb83]{height:1px;background:rgba(255,255,255,.15)}.darkMode .bottom-shadow[data-v-753ceb83]:after,.darkMode .top-shadow[data-v-753ceb83]:after{opacity:.3;height:40px}.top-shadow[data-v-753ceb83]:after{top:0;background:linear-gradient(to bottom,#000 0,rgba(0,0,0,.878) 4.3%,rgba(0,0,0,.764) 8.6%,rgba(0,0,0,.657) 12.9%,rgba(0,0,0,.558) 17.3%,rgba(0,0,0,.467) 21.9%,rgba(0,0,0,.384) 26.8%,rgba(0,0,0,.309) 32.2%,rgba(0,0,0,.243) 38%,rgba(0,0,0,.184) 44.4%,rgba(0,0,0,.133) 51.4%,rgba(0,0,0,.09) 59.2%,rgba(0,0,0,.055) 67.9%,rgba(0,0,0,.028) 77.5%,rgba(0,0,0,.01) 88.2%,rgba(0,0,0,0) 100%)}.bottom-shadow[data-v-753ceb83]:after{bottom:0;background:linear-gradient(to top,#000 0,rgba(0,0,0,.878) 4.3%,rgba(0,0,0,.764) 8.6%,rgba(0,0,0,.657) 12.9%,rgba(0,0,0,.558) 17.3%,rgba(0,0,0,.467) 21.9%,rgba(0,0,0,.384) 26.8%,rgba(0,0,0,.309) 32.2%,rgba(0,0,0,.243) 38%,rgba(0,0,0,.184) 44.4%,rgba(0,0,0,.133) 51.4%,rgba(0,0,0,.09) 59.2%,rgba(0,0,0,.055) 67.9%,rgba(0,0,0,.028) 77.5%,rgba(0,0,0,.01) 88.2%,rgba(0,0,0,0) 100%)}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$2 = "data-v-753ceb83";
    /* module identifier */
