...
(function (global, factory) {
  ...
  var __vue_staticRenderFns__ = [];
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-b0410dd2_0", { source: ".toast-list[data-v-b0410dd2]{position:fixed;top:36px;left:10px;right:10px;z-index:1100;user-select:none;pointer-events:none}.toast-list-inner[data-v-b0410dd2]{max-width:450px;margin:0 auto;position:relative;text-align:center}.toast-notification[data-v-b0410dd2]{display:inline-block;padding:15px 25px;margin-bottom:5px;word-break:break-word;color:#fff;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600;background:#40444a;border-radius:4px;box-shadow:0 2px 10px -2px rgba(0,0,0,.2);pointer-events:all;user-select:none}.toast-list-enter[data-v-b0410dd2],.toast-list-leave-to[data-v-b0410dd2]{opacity:0}.toast-list-enter-active[data-v-b0410dd2],.toast-list-leave-active[data-v-b0410dd2],.toast-list-move[data-v-b0410dd2]{transition:all .2s}.toast-list-leave-active[data-v-b0410dd2]{position:absolute;left:0;right:0}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$2 = "data-v-b0410dd2";
    /* module identifier */
  ...
  var __vue_staticRenderFns__$1 = [];
    ...
    const __vue_inject_styles__$3 = function (inject) {
      if (!inject) return
      inject("data-v-24e179ea_0", { source: ".tooltip-enter-active[data-v-24e179ea]{transition:opacity .1s}.tooltip-enter[data-v-24e179ea]{opacity:0}.tooltip-arrow-enter-active[data-v-24e179ea]{transition:opacity 150ms}.tooltip-arrow-enter[data-v-24e179ea]{opacity:0}.r-tooltip[data-v-24e179ea]{position:fixed;z-index:1000;padding:5px 12px;margin-right:5px;word-break:break-word;color:#fff;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600;background:#40444a;border-radius:4px;box-shadow:0 2px 10px -2px rgba(0,0,0,.2);pointer-events:none;user-select:none}.r-tooltip-arrow[data-v-24e179ea]{position:fixed;z-index:1001;border-top:7px solid #40444a;border-left:7px solid transparent;border-right:7px solid transparent;border-bottom:7px solid transparent}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$3 = "data-v-24e179ea";
    /* module identifier */
