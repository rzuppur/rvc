...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('portal-vue'), require('resize-observer-polyfill')) :
  typeof define === 'function' && define.amd ? define(['portal-vue', 'resize-observer-polyfill'], factory) :
  (global = global || self, global.Rvc = factory(global.PortalVue, global.ResizeObserver));
}(this, function (PortalVue, ResizeObserver) { 'use strict';

  var PortalVue__default = 'default' in PortalVue ? PortalVue['default'] : PortalVue;
  ...
  /* template */
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-498de817_0", { source: ".r-icon{height:24px;width:24px;display:inline-block}.r-icon.icon-text{vertical-align:text-bottom;display:inline-block;position:relative;top:1px}.r-icon.icon-text,.r-icon.icon-text svg{height:18px!important;width:18px!important}.darkMode .r-icon svg{fill:#e1e3e5}.r-icon.gray svg{fill:#777}.darkMode .r-icon.gray svg{fill:#aab0b6}.r-icon.light-gray svg{fill:#aaa}.r-icon.green svg{fill:#009635}.darkMode .r-icon.green svg{fill:#00aa3c}.r-icon.red svg{fill:#e24161}.darkMode .r-icon.red svg{fill:#e55370}.r-icon.blue svg{fill:#2097e8}.darkMode .r-icon.blue svg{fill:#1584cf}.r-icon.gold svg{fill:#eebc41}.r-icon.white svg{fill:#fff}", map: undefined, media: undefined });
  ...
  /* template */
  var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('portal',{attrs:{"to":"r-modals"}},[_c('transition',{attrs:{"name":"modal"}},[(_vm.modalOpen)?_c('div',{staticClass:"modal-overlay",style:({ 'z-index': _vm.modalOverlayZIndex }),on:{"click":_vm.outsideClose,"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"esc",27,$event.key,["Esc","Escape"])){ return null; }$event.stopPropagation();return _vm.outsideClose($event)}}},[_c('div',{staticClass:"modal-container r-container",class:_vm.modalContainerClass},[_c('div',{ref:"modal",staticClass:"modal r-background-primary",style:({ 'z-index': _vm.modalZIndex }),attrs:{"role":"dialog","aria-labelledby":_vm.title ? ("dialog-title-" + _vm._id) : null},on:{"click":function($event){$event.stopPropagation();}},nativeOn:{"!keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"esc",27,$event.key,["Esc","Escape"])){ return null; }return _vm.outsideClose($event)}}},[(_vm.title !== false)?_c('div',{staticClass:"modal-header"},[_c('h1',{staticClass:"title title-5",attrs:{"id":("dialog-title-" + _vm._id)}},[_vm._v(_vm._s(_vm.title))]),(!_vm.blocking)?_c('r-button',{attrs:{"borderless":"borderless","action":_vm.close,"label":"Close dialog","icon":"close"}}):_vm._e()],1):_vm._e(),(_vm.showTopBorder)?_c('div',{staticClass:"flex0 top-shadow"}):_vm._e(),_c('div',{ref:"modalContent",staticClass:"modal-content",class:{ 'modal-content-scroll': _vm.contentScrolls, 'no-buttons': !_vm.buttons },on:{"&scroll":function($event){return _vm.updateScrollPosition($event)}}},[_c('div',{staticClass:"modal-content-inner"},[_vm._t("default")],2)]),(_vm.showBottomBorder)?_c('div',{staticClass:"flex0 bottom-shadow"}):_vm._e(),(_vm.buttons)?_c('div',{staticClass:"modal-buttons"},[_c('div',{staticClass:"r-buttons"},[_vm._t("buttons",[_c('r-button',{attrs:{"action":_vm.close}},[_vm._v("Close")])],{"close":_vm.close})],2)]):_vm._e()])])]):_vm._e()])],1)};
  var __vue_staticRenderFns__ = [];

    /* style */
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-1ee4f641_0", { source: ".modal-enter-active[data-v-1ee4f641],.modal-leave-active[data-v-1ee4f641]{transition:opacity 120ms ease-out}.modal-enter-active .modal[data-v-1ee4f641],.modal-leave-active .modal[data-v-1ee4f641]{transition:transform 120ms ease-out}.modal-enter[data-v-1ee4f641],.modal-leave-to[data-v-1ee4f641]{opacity:0}.modal-enter .modal[data-v-1ee4f641],.modal-leave-to .modal[data-v-1ee4f641]{transform:scale(.97)}@media (max-width:480px){.modal-enter-active[data-v-1ee4f641],.modal-leave-active[data-v-1ee4f641]{transition:opacity 170ms ease-out}.modal-enter-active .modal[data-v-1ee4f641],.modal-leave-active .modal[data-v-1ee4f641]{transition:transform .2s cubic-bezier(.31,.79,.46,.92)}.modal-enter .modal[data-v-1ee4f641],.modal-leave-to .modal[data-v-1ee4f641]{transform:translateY(12px)}}.modal-overlay[data-v-1ee4f641]{overflow:hidden;-webkit-overflow-scrolling:touch;position:fixed;text-align:center;left:0;top:0;right:0;bottom:0;height:100%;background:rgba(24,27,34,.6)}.darkMode .modal-overlay[data-v-1ee4f641]{background:rgba(19,22,27,.9)}@supports (display:grid){@media (min-width:481px){.modal-overlay[data-v-1ee4f641]{grid-template-columns:100%;grid-template-rows:1fr max-content 2fr;display:grid}.modal-overlay .modal-container[data-v-1ee4f641]{grid-column:1;grid-row:2;width:100%}}}.modal-container[data-v-1ee4f641]{text-align:left}.modal[data-v-1ee4f641]{border-radius:4px;word-wrap:break-word;overflow-y:auto;display:flex;flex-direction:column;max-height:calc(100vh - 24px);box-shadow:0 0 0 3px rgba(0,0,0,.15),0 15px 10px -5px rgba(0,0,0,.07)}.darkMode .modal[data-v-1ee4f641]{box-shadow:0 0 0 3px rgba(255,255,255,.1),0 15px 30px -5px rgba(0,0,0,.5)}.modal-buttons[data-v-1ee4f641],.modal-header[data-v-1ee4f641]{padding:24px;flex:0 0 auto}.modal-header[data-v-1ee4f641]{padding-bottom:12px}.modal-header[data-v-1ee4f641]{display:flex}.modal-header .title[data-v-1ee4f641]{flex:1 1 auto;align-self:center;margin:0}.modal-header .modal-close[data-v-1ee4f641]{flex:0 0 auto;align-self:flex-start}.modal-content[data-v-1ee4f641]{padding:0 24px;flex:0 1 auto;overflow:hidden}.modal-content.no-buttons[data-v-1ee4f641]{padding-bottom:24px}.modal-content.modal-content-scroll[data-v-1ee4f641]{min-height:48px;padding:0 24px 24px;overflow-y:auto}@media (max-width:480px){.modal-container[data-v-1ee4f641]{padding:0}.modal-container[data-v-1ee4f641]{justify-content:flex-end;height:100%;display:flex;flex-direction:column}.modal[data-v-1ee4f641]{border-radius:0}}.bottom-shadow[data-v-1ee4f641],.top-shadow[data-v-1ee4f641]{position:relative;z-index:10}.bottom-shadow[data-v-1ee4f641]:after,.top-shadow[data-v-1ee4f641]:after{content:\"\";user-select:none;pointer-events:none;height:20px;position:absolute;left:0;right:0;opacity:.07}.darkMode .bottom-shadow[data-v-1ee4f641],.darkMode .top-shadow[data-v-1ee4f641]{height:1px;background:rgba(255,255,255,.15)}.darkMode .bottom-shadow[data-v-1ee4f641]:after,.darkMode .top-shadow[data-v-1ee4f641]:after{opacity:.3;height:40px}.top-shadow[data-v-1ee4f641]:after{top:0;background:linear-gradient(to bottom,#000 0,rgba(0,0,0,.878) 4.3%,rgba(0,0,0,.764) 8.6%,rgba(0,0,0,.657) 12.9%,rgba(0,0,0,.558) 17.3%,rgba(0,0,0,.467) 21.9%,rgba(0,0,0,.384) 26.8%,rgba(0,0,0,.309) 32.2%,rgba(0,0,0,.243) 38%,rgba(0,0,0,.184) 44.4%,rgba(0,0,0,.133) 51.4%,rgba(0,0,0,.09) 59.2%,rgba(0,0,0,.055) 67.9%,rgba(0,0,0,.028) 77.5%,rgba(0,0,0,.01) 88.2%,rgba(0,0,0,0) 100%)}.bottom-shadow[data-v-1ee4f641]:after{bottom:0;background:linear-gradient(to top,#000 0,rgba(0,0,0,.878) 4.3%,rgba(0,0,0,.764) 8.6%,rgba(0,0,0,.657) 12.9%,rgba(0,0,0,.558) 17.3%,rgba(0,0,0,.467) 21.9%,rgba(0,0,0,.384) 26.8%,rgba(0,0,0,.309) 32.2%,rgba(0,0,0,.243) 38%,rgba(0,0,0,.184) 44.4%,rgba(0,0,0,.133) 51.4%,rgba(0,0,0,.09) 59.2%,rgba(0,0,0,.055) 67.9%,rgba(0,0,0,.028) 77.5%,rgba(0,0,0,.01) 88.2%,rgba(0,0,0,0) 100%)}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$2 = "data-v-1ee4f641";
    /* module identifier */
  ...
  var __vue_staticRenderFns__$1 = [];
    ...
    /* scoped */
    const __vue_scope_id__$3 = "data-v-3609e4d6";
    /* module identifier */
  ...
  /* template */
  var __vue_render__$2 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"r-tabs"},[_c('div',{staticClass:"tabs"},_vm._l((_vm.tabs),function(tab){return _c('r-button',{key:'tab-' + tab.name,staticClass:"tab",class:{ active: tab.isActive },attrs:{"action":function () { _vm.setTabActive(tab.name); },"borderless":"borderless"}},[_c('span',{class:{ 'text-quiet': !tab.isActive }},[_vm._v(_vm._s(tab.name))])])}),1),_c('div',{staticClass:"line margin-bottom-medium",class:{ extendLine: _vm.extendLine }}),_c('div',{staticClass:"tabs-content"},[_vm._t("default")],2)])};
  var __vue_staticRenderFns__$2 = [];

    /* style */
    const __vue_inject_styles__$4 = function (inject) {
      if (!inject) return
      inject("data-v-72c3dedd_0", { source: ".line[data-v-72c3dedd]{margin-top:-1px;border-bottom:1px solid #eee}.darkMode .line[data-v-72c3dedd]{border-bottom-color:rgba(255,255,255,.15)}.line.extendLine[data-v-72c3dedd]{margin-left:-24px;margin-right:-24px}.tab[data-v-72c3dedd]{border-radius:0}.tab.active[data-v-72c3dedd]{border-top:3px solid transparent;border-bottom:3px solid #0d7cc8;color:#1c69ab}.darkMode .tab.active[data-v-72c3dedd]{color:#45a8ec}.tab .text-quiet[data-v-72c3dedd]{font-weight:400}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$4 = "data-v-72c3dedd";
    /* module identifier */
  ...
  var __vue_staticRenderFns__$3 = [];
    ...
    /* scoped */
    const __vue_scope_id__$5 = "data-v-7735b126";
    /* module identifier */
  ...
  /* template */
    ...
    const __vue_inject_styles__$6 = function (inject) {
      if (!inject) return
      inject("data-v-4fa6cec6_0", { source: "*,::after,::before{box-sizing:border-box}ol[class],ul[class]{padding:0;list-style:none}blockquote,body,dd,dl,figcaption,figure,h1,h2,h3,h4,li,ol[class],p,pre,ul[class]{margin:0}body{scroll-behavior:smooth;-webkit-text-size-adjust:100%;text-size-adjust:100%;font-kerning:normal;background:$color-white}#app,body{min-height:100vh}a:not([class]){text-decoration-skip-ink:auto}img{max-width:100%;display:block}button,input,select,textarea{font:inherit}h1,h2,h3,h4,h5,h6{font-weight:inherit;font-size:inherit}body{font-family:Inter,BlinkMacSystemFont,-apple-system,\"Segoe UI\",Roboto,Oxygen-Sans,Ubuntu,Cantarell,\"Helvetica Neue\",sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";line-height:1.5;word-break:break-word;color:#40444a}b,strong{font-weight:600}p,pre{margin-bottom:24px}p:last-child,pre:last-child{margin-bottom:0}p{font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:400}a{text-underline-position:under;color:#1c69ab;cursor:pointer}a:visited{color:#3a598d}.darkMode a{color:#2097e8}.darkMode a:visited{color:#2076e8}.title-1{word-wrap:break-word;margin-bottom:12px}.title-1:not(:first-child){margin-top:48px}.title-2{word-wrap:break-word;margin-bottom:12px}.title-2:not(:first-child){margin-top:48px}.title-3{word-wrap:break-word;margin-bottom:12px}.title-3:not(:first-child){margin-top:48px}.title-4{word-wrap:break-word;margin-bottom:12px}.title-4:not(:first-child){margin-top:48px}.title-5{word-wrap:break-word;margin-bottom:12px}.title-5:not(:first-child){margin-top:48px}.title-6{word-wrap:break-word;margin-bottom:12px}.title-6:not(:first-child){margin-top:48px}.title-caps{word-wrap:break-word;margin-bottom:12px}.title-caps:not(:first-child){margin-top:48px}.title-1{font-size:67px;letter-spacing:-.017em;line-height:70px;font-weight:400}.title-2{font-size:51px;letter-spacing:-.017em;line-height:60px;font-weight:400}.title-3{font-size:38px;letter-spacing:-.017em;line-height:49px;font-weight:400}.title-4{font-size:28px;letter-spacing:-.015em;line-height:39px;font-weight:400}.title-5{font-size:21px;letter-spacing:-.012em;line-height:31px;font-weight:400}.title-6{font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600}.title-caps{font-size:13px;letter-spacing:.004em;line-height:20px;font-weight:600;text-transform:uppercase;letter-spacing:.1em}.text-bold{font-weight:600}.text-center{text-align:center}.text-right{text-align:right}.text-quiet{color:#777}.darkMode .text-quiet{color:#aab0b6}.text-error{color:#a61216}.darkMode .text-error{color:#e24161}.text-small{font-size:13px;letter-spacing:.004em;line-height:20px;font-weight:400}hr{height:2px;border:none;outline:0;margin:16px 0;padding:0;box-shadow:none;background:#eee}.darkMode hr{background:rgba(255,255,255,.15)}.r-background-primary{background:#fff;color:#40444a}.darkMode .r-background-primary{background:#181b22;color:#e1e3e5}.r-background-secondary{background:#f9f9fa;color:#40444a}.darkMode .r-background-secondary{background:#232832;color:#e1e3e5}.r-buttons{margin-right:-6px;margin-bottom:-6px}.r-buttons.align-right{text-align:right}.r-buttons .r-button{margin-right:6px;margin-bottom:6px}.r-buttons-grouped{margin-right:-6px;margin-bottom:-6px}.r-buttons-grouped .r-button-group{display:inline-block;margin-right:6px;margin-bottom:6px}.r-buttons-grouped .r-button-group .r-button+.r-button{border-top-left-radius:0;border-bottom-left-radius:0;border-left:none}.r-buttons-grouped .r-button-group .r-button:not(:last-child){border-top-right-radius:0;border-bottom-right-radius:0}.margin-top-huge[class]{margin-top:96px}.margin-top-large[class]{margin-top:48px}.margin-top-medium[class]{margin-top:24px}.margin-top-small[class]{margin-top:12px}.margin-top-tiny[class]{margin-top:6px}.margin-bottom-huge[class]{margin-bottom:96px}.margin-bottom-large[class]{margin-bottom:48px}.margin-bottom-medium[class]{margin-bottom:24px}.margin-bottom-small[class]{margin-bottom:12px}.margin-bottom-tiny[class]{margin-bottom:6px}.margin-left-huge[class]{margin-left:96px}.margin-left-large[class]{margin-left:48px}.margin-left-medium[class]{margin-left:24px}.margin-left-small[class]{margin-left:12px}.margin-left-tiny[class]{margin-left:6px}.margin-right-huge[class]{margin-right:96px}.margin-right-large[class]{margin-right:48px}.margin-right-medium[class]{margin-right:24px}.margin-right-small[class]{margin-right:12px}.margin-right-tiny[class]{margin-right:6px}.margin-top-none{margin-top:0!important}.margin-bottom-none{margin-bottom:0!important}.margin-vertical-none{margin-top:0!important;margin-bottom:0!important}.margin-horizontal-none{margin-left:0!important;margin-right:0!important}.margin-none{margin:0!important}.r-fullheight-parent{position:relative}.r-fullheight-parent>.r-fullheight{position:absolute;top:0;bottom:0;left:0;right:0}.r-container{margin-left:auto;margin-right:auto;padding-left:24px;padding-right:24px}.r-container-huge{max-width:1440px}.r-container-large{max-width:960px}.r-container-medium{max-width:720px}.r-container-small{max-width:480px}.r-container-tiny{max-width:240px}.r-container-maximum{max-width:none}.r-container-row{display:flex;flex-direction:row;margin-left:auto;margin-right:auto;overflow-x:auto;overflow-y:hidden}.r-container-row>.r-container-column{flex-grow:0;flex-shrink:1;min-width:216px;max-width:none;padding-left:24px;padding-right:24px}.r-container-row>.r-container-huge{flex-basis:1440px}.r-container-row>.r-container-large{flex-basis:960px}.r-container-row>.r-container-medium{flex-basis:720px}.r-container-row>.r-container-small{flex-basis:480px}.r-container-row>.r-container-tiny{flex-basis:240px}.r-container-row>.r-container-maximum{flex-grow:1;flex-basis:100%}@media (max-width:960px){.r-container-row.r-columns-mobile-large{display:block;position:static}.r-container-row.r-columns-mobile-large>.r-container-column{max-width:none;min-width:0}}@media (max-width:720px){.r-container-row.r-columns-mobile-medium{display:block;position:static}.r-container-row.r-columns-mobile-medium>.r-container-column{max-width:none;min-width:0}}@media (max-width:480px){.r-container-row.r-columns-mobile-small{display:block;position:static}.r-container-row.r-columns-mobile-small>.r-container-column{max-width:none;min-width:0}}.r-container-row.r-fullheight>.r-container-column{overflow-y:auto;-webkit-overflow-scrolling:touch}.flex0{flex:0 0 auto}.flex1{flex:1 1 auto}.flex2{flex:2 2 auto}.flex3{flex:3 3 auto}body.r-modal-open{overflow:hidden}@media (max-width:720px){.r-media-hide-medium{display:none}}@media (min-width:721px){.r-media-show-medium{display:none}}@media (max-width:480px){.r-media-hide-small{display:none}}@media (min-width:481px){.r-media-show-small{display:none}}", map: undefined, media: undefined });
    ...
    var GlobalStyles = normalizeComponent_1(
      {},
  ...
  var __vue_staticRenderFns__$4 = [];
    ...
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-e5305cf2_0", { source: ".toast-list[data-v-e5305cf2]{position:fixed;top:36px;left:10px;right:10px;z-index:13000;user-select:none;pointer-events:none}.toast-list-inner[data-v-e5305cf2]{max-width:700px;margin:0 auto;position:relative;text-align:center}.toast-notification[data-v-e5305cf2]{display:inline-block;padding:15px 25px;margin-bottom:5px;word-break:break-word;color:#fff;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600;background:#40444a;border-radius:4px;box-shadow:0 2px 10px -2px rgba(0,0,0,.2);pointer-events:all;user-select:none}.toast-list-enter[data-v-e5305cf2],.toast-list-leave-to[data-v-e5305cf2]{opacity:0}.toast-list-enter-active[data-v-e5305cf2],.toast-list-leave-active[data-v-e5305cf2],.toast-list-move[data-v-e5305cf2]{transition:all .2s}.toast-list-leave-active[data-v-e5305cf2]{position:absolute;left:0;right:0}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$7 = "data-v-e5305cf2";
    /* module identifier */
  ...
  /* template */
  var __vue_render__$5 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('transition',{attrs:{"name":"tooltip"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],ref:"tooltip",staticClass:"r-tooltip",style:(_vm.tooltipStyle)},[_vm._v(_vm._s(_vm.text))])]),_c('transition',{attrs:{"name":"tooltip-arrow"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],staticClass:"r-tooltip-arrow",style:(_vm.arrowStyle)})])],1)};
  var __vue_staticRenderFns__$5 = [];

    /* style */
    const __vue_inject_styles__$8 = function (inject) {
      if (!inject) return
      inject("data-v-68b7ae14_0", { source: ".tooltip-enter-active[data-v-68b7ae14]{transition:opacity .1s}.tooltip-enter[data-v-68b7ae14]{opacity:0}.tooltip-arrow-enter-active[data-v-68b7ae14]{transition:opacity 150ms}.tooltip-arrow-enter[data-v-68b7ae14]{opacity:0}.r-tooltip[data-v-68b7ae14]{position:fixed;z-index:12000;padding:5px 12px;margin-right:5px;word-break:break-word;color:#fff;font-size:16px;letter-spacing:-.005em;line-height:24px;font-weight:600;background:#40444a;border-radius:4px;box-shadow:0 2px 10px -2px rgba(0,0,0,.2);pointer-events:none;user-select:none}.r-tooltip-arrow[data-v-68b7ae14]{position:fixed;z-index:12001;border-top:7px solid #40444a;border-left:7px solid transparent;border-right:7px solid transparent;border-bottom:7px solid transparent;pointer-events:none;user-select:none}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$8 = "data-v-68b7ae14";
    /* module identifier */
    ...
    Vue.mixin({
      ...
      mounted: function mounted() {
        ...
        if (!this.$parent) {
          ...
          globalStylesComponent = mountComponentToRoot(Vue, this, GlobalStyles); // @ts-ignore
